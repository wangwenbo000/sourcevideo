<template>
  <div class="join">
    ...
    <div class="joinTop">
      ...
      <div class="center">
        <p>索斯光影是一个充满活力，追求完美的团队，秉持整合优质业界资源与锐意创新的先锋理念，拥有一流的影视节目制作与平面设计团队，并致力于影视视频制作营销策划与文化传播经营整合a。</p>
      </div>
      <div class="right">
    ...
    <ul>
      <li v-for="t in teamlist | orderBy 'order' 1" @mouseenter="t.showCardInfo=true"
          @mouseleave="t.showCardInfo=false" class="memberInfo">

        <a v-link="{name:'membercard',params:{id:t.id}}">
          <img :src="'/static/img/face/'+ t.face" class="gray">
...
<script type="text/babel">
  export default{
    ...
    ready(){
      new imagesLoaded('.memberInfo',function(){
        console.log("a");
      });
    },
    route: {
