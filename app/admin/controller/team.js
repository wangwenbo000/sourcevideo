...
var fs = require('fs');var _default = (function (_Base) {_inherits(_default, _Base);function _default() {_classCallCheck(this, _default);_Base.apply(this, arguments);}
   ...
   */_default.prototype.
  M = function M() {
    return this.model('team');};_default.prototype.
  ...
  delcoverAction = function delcoverAction() {var 
    imgPath;return _regeneratorRuntime.async(function delcoverAction$(context$2$0) {var _this3 = this;while (1) switch (context$2$0.prev = context$2$0.next) {case 0:imgPath = think.RESOURCE_PATH + '/static/img/face/' + this.post().filename;
          fs.unlink(imgPath, function (err) {
  ...
  uploadcoverAction = function uploadcoverAction() {var 
    ...
    newFileName, 
    oldPath, 
    newPath;return _regeneratorRuntime.async(function uploadcoverAction$(context$2$0) {while (1) switch (context$2$0.prev = context$2$0.next) {case 0:_this = this;uploadInfo = this.file('face');newFileName = _moment2['default']().format('YYYYMMDDHHmmss') + ".jpg";oldPath = uploadInfo.path;newPath = think.RESOURCE_PATH + '/static/img/face/';
