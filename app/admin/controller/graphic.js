...
var fs = require('fs');var _class = function (_Base) {(0, _inherits3.default)(_class, _Base);function _class() {(0, _classCallCheck3.default)(this, _class);return (0, _possibleConstructorReturn3.default)(this, _Base.apply(this, arguments));}
   ...
   */_class.prototype.
  M = function M() {
    return this.model('graphic');};_class.prototype.
  ...
  delAction = function () {var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3() {var _this3 = this;var 
      delGraphic, 
      imgPath;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return this.M().where({ id: this.post().id }).delete();case 2:delGraphic = _context3.sent;imgPath = think.RESOURCE_PATH + '/static/img/graphic/' + this.post().filename;
  ...
  delcoverAction = function () {var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4() {var _this4 = this;var 
      imgPath;return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:imgPath = think.RESOURCE_PATH + '/static/img/graphic/' + this.post().filename;
              fs.unlink(imgPath, function (err) {
  ...
  uploadcoverAction = function () {var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5() {var 
      ...
      newFileName, 
      oldPath, 
      newPath;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_this = this;uploadInfo = this.file('graphic_cover');newFileName = (0, _moment2.default)().format('YYYYMMDDHHmmss') + ".jpg";oldPath = uploadInfo.path;newPath = think.RESOURCE_PATH + '/static/img/graphic/';
